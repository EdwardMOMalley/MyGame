...
class StartDrawComponent extends Component {
    draw(ctx) {
        ...
        ctx.fillText("Welcome to <PLACEHOLDER>", 100, 100);
    }
}
...
class GameDrawComponent extends Component {
    start() {
...
class GameDrawGameObject extends GameObject {
    start() {
        let gameComponent = new GameDrawComponent();
        this.addComponent(gameComponent)
    }
}


class GameUpdateComponent extends Component {
}

class GameUpdateObject extends GameObject {
    start() {
        this.addComponent(new GameUpdateComponent)
    }
}
...
class GameScene extends Scene {
    start() {
        this.addGameObject(new GameDrawGameObject())
        this.addGameObject(new GameUpdateObject())
    }
}
